...
const plans = [
  { id: 'monthly', label: 'شهري', price: '29', unit: 'جنيه/شهر', badge: '' },
  { id: 'yearly', label: 'سنوي', price: '199', unit: 'جنيه/سنة', badge: 'الأوفر', savings: 'وفّر 47%' },
];

export default function ProScreen({ navigate }: NavProps) {
  return (
    <div className="w-full h-full flex flex-col bg-[#F0F4FF]">
      ...
      >
        ...
        {[
          ...
          { top: '55%', left: '5%' }, { top: '40%', left: '92%' },
        ].map((pos, i) => (
          <div key={i} className="absolute text-amber-400 text-lg opacity-60" style={{ top: pos.top, left: pos.left }}>⭐</div>
        ))}
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5">
            ...
            <div
              ...
              style={{
                background: plan.badge
                  ...
                  : 'white',
                border: plan.badge ? 'none' : '1.5px solid #F1F5F9',
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <div className="text-left">
                  {plan.savings && (
                    <div
                      className="text-xs font-black px-2 py-0.5 rounded-lg mb-1"
                  ...
                  <div className="flex items-end gap-1">
                    <span
                      ...
                      style={{ color: plan.badge ? 'white' : '#0F172A' }}
                    >
                      {plan.price}
                    </span>
                    <span
                      className="text-sm font-medium mb-1"
                      style={{ color: plan.badge ? 'rgba(255,255,255,0.6)' : '#94A3B8' }}
                    >
                      {plan.unit}
                    </span>
                  </div>
                ...
                <div className="text-right">
                  ...
                  <div
                    ...
                    style={{ color: plan.badge ? 'rgba(255,255,255,0.5)' : '#94A3B8' }}
                  >
        ...
        {/* CTA */}
        <button
          onClick={() => navigate('pro_dashboard')}
